...
// Creating function for XMLHttpRequest onload
xhr.onload = function () {
    if (this.status === 200) {
        ...
        articles.forEach(function (element, index) {
            // creating html templete for news card
            let news = `
...
`;
        ...
        // implementing the value into newsAccordion card
